...
function Ssdp() {
    ...
    this.mSearch = function (st) {
        ...
        var mSearchRequester = dgram.createSocket({type: 'udp4', reuseAddr: true}, announceDiscoveredDevice(this));
        ...
        try {
            mSearchRequester.on('error', function () {
                console.log('catch error');
                mSearchRequester.close();
            });
            // Otherwise it'll bind on 0.0.0.0
            mSearchRequester.bind(undefined, ip.address(), function () {
